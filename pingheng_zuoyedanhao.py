...
db1=MySQLdb.connect(host="127.0.0.1",user="root",passwd="123456",db="zt24-1",charset='utf8')
db2=MySQLdb.connect(host="127.0.0.1",user="root",passwd="123456",db="zt24-2",charset='utf8')
db20130120=MySQLdb.connect(host="127.0.0.1",user="root",passwd="123456",db="zt-test",charset='utf8')
